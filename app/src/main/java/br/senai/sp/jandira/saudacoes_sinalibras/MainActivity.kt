package br.senai.sp.jandira.saudacoes_sinalibras
...
import br.senai.sp.jandira.saudacoes_sinalibras.ui.theme.SaudacoesSinaLibrasTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            SaudacoesSinaLibrasTheme {
                Saudacoes()
            }
        }
    }
